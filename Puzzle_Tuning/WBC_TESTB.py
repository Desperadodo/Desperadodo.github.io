...
def MIL_to_CLS(dataset_root, output_root):
    ...
    find_copy_all_files(dataset_root, output_root, 'jpg', add_class=True)

if __name__ == '__main__':

    input_root_data = r'D:\CPIA_Version1\PuzzleTuningDatasets#1_Lite\S_Scale\WBC_Test-B'
    output_root_data = r'D:\CPIA_VersionJournal\PuzzleTuningDatasets#1_MJ\S_Scale\WBC_CLS'
