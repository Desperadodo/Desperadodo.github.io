...
def read_and_convert(data_root, save_root, suffix=None, patient_folder=False, L=True, M=True, S=False):
    ...
    # class_names = ['CPTAC-CCRCC']
    # 接下来一行代码只在断点续传使用
    class_names = class_names[class_names.index('CPTAC-LSCC') :]
    ...
    for class_name in class_names:
        ...
        # 接下来一行代码只在断点续传使用
        if class_name == 'CPTAC-LSCC':
            svs_all_files = svs_all_files[svs_all_files.index(r'E:\Puzzle_Tuning_Datasets\Raw\WSI\CPTAC-LSCC\LSCC\C3L-04336-28.svs') + 1:]
        name_dir_3840 = {}
        name_dir_0 = {}
        name_dir_1 = {}
        name_dir_2 = {}
