...
if __name__ == '__main__':
    data_crop_resize(r'F:\Puzzle Tuning Datasets\P. vivax（NIH-NLM-ThickBloodSmearsPV)\NIH-NLM-ThickBloodSmearsPV\All_PvTk',
                     r'D:\CPIA_VersionJournal\CPIA_MJ\S\P_vivax',
                     384)