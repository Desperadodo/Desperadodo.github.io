...
def pc_to_stander(root_from, root_to):
    ...
    with open(r'E:\A_bunch_of_data\Raw\PCam\sample_submission.csv', 'r') as f:
        reader = csv.reader(f)
        result = list(reader)
        length = len(result)
...
if __name__ == '__main__':
    pc_to_stander(root_from=r'E:\A_bunch_of_data\Raw\PCam\test',
                  root_to=r"E:\A_bunch_of_data\CLS\PCam\test")
