'''
'data_mask_split' ver 22 Nov 10
split data&mask into 'test' 'train' 'val'
...
def a_dataset_split(src_data_folder, class_name, train_scale, val_scale, test_scale, com_num=None):
    ...
    for i in current_data_mask_index_list:
        ...
        src_data_path = os.path.join(current_class_data_path, current_all_data_mask[i])
        img_name = os.path.split(src_mask_path)[1].split('.')[0]
        # print("ok...")
...
if __name__ == '__main__':
    ...
    src_data_folder = r'D:\cervical_jpg\Cropped_Labeled'
    target_data_folder = r'D:\cervical_jpg\SIPaKMeD_MIL'
    data_set_split(src_data_folder, target_data_folder, train_scale=0.7, val_scale=0.1, test_scale=0.2)
