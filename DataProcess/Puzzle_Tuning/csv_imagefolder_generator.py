"""
'csv_imagefolder_generator' ver 22 Nov 10
used after a model has run out a .csv file containing the classify result of a dataset
...
if __name__ == '__main__':
    trans_csv_folder_to_imagefoder(
        target_path=r'/Users/munros/PuzzleTuning/Processed/bgCLS_Colonoscopy_test',
        original_path=r'/Users/munros/PuzzleTuning/Raw/Colonoscopy/mixed',
        csv_path=r'/Users/munros/Desktop/data_process/Puzzle_Tuning/inferance.csv'
    )